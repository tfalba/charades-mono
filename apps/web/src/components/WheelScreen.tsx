...
//   { name: "Owen", color: "#FACC15" }, // yellow
  { name: "Gwen", color: "#EC4899" }, // pink
  { name: "Xavier", color: "#22C55E" }, // green
];
...
export const WheelScreen: React.FC<WheelScreenProps> = ({
  ...
  return (
    <div className="min-h-auto flex flex-wrap gap-4 items-center justify-center bg-midnight/80 text-white">
      <PrizeWheel players={players} onSpinEnd={onPlayerSelected} />
      <ScoreBoard
